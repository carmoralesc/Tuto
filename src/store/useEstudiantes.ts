...
const ESTUDIANTES_MUESTRA: Estudiante[] = [
  {
    ...
    materiasEspeciales: [],
    materiasProguestas: ['m2', 'm4', 'm6', 'm8'],
    puntajeRiesgo: 0,
    estado: 'PENDIENTE',
  },
  {
    ...
    materiasProguestas: ['m8', 'm9', 'm10', 'm12'],
    puntajeRiesgo: 0,
    estado: 'MODIFICADO',
  },
  {
    ...
    materiasProguestas: ['m1', 'm3', 'm5', 'm7'],
    puntajeRiesgo: 0,
    estado: 'NO_ENTREGADO',
  },
  {
    ...
    materiasRepetidas: [],
    materiasEspeciales: [],
    materiasProguestas: ['m10', 'm11', 'm12'],
    puntajeRiesgo: 0,
    estado: 'APROBADO',
  },
];
  ...
  actualizarCarga: (estudianteId, materias) => {
    set(state => ({
      estudiantes: state.estudiantes.map(e => {
        ...
        const updated = { ...e, materiasProguestas: materias, estado: 'MODIFICADO' as const };
        return {
          ...updated,
